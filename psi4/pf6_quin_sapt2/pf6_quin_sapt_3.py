...
def calculate_energies(geometrias):
    ...
    for i, geometria in enumerate(geometrias):
        ...
        esapt[i], eind[i], edisp[i], eelst[i], eexch[i] = [
            psi4.variable(name) for name in
...
coor = np.load('/home/miguel/QM_Project/configurations/quin_configurations_180.npy')
archivo_mol1 = '/home/miguel/QM_Project/coord_archives/pf6_centered_180_3.xyz'
